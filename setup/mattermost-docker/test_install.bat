...
powershell -c "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12;Invoke-WebRequest -Uri 'https://github.com/calicoquito/quito.core/releases/download/v1.0-alpha1.1/quito_installer_windows.bat' -OutFile ${PWD}/quito_test_installer_windows.bat"
...
del /f docker-compose.yml
del /f .gitignore
powershell -c "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12;Invoke-WebRequest -Uri 'https://github.com/calicoquito/quito.core/releases/download/v1.0-alpha1.1/quito_full.zip' -OutFile ${PWD}/quito_full.zip"
...
cd env 
powershell -c "python createPass.py"
del /f createPass.py
cd ..
echo Installing
