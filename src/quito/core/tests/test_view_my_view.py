# -*- coding: utf-8 -*-
from quito.core.testing import QUITO_CORE_FUNCTIONAL_TESTING
from quito.core.testing import QUITO_CORE_INTEGRATION_TESTING
...
class ViewsFunctionalTest(unittest.TestCase):
    ...
    layer = QUITO_CORE_FUNCTIONAL_TESTING
